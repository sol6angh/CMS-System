...
<form method="post" action="<?php echo base_url(); ?>admin/categories/edit/<?php echo $categories->id; ?>">
				  <div class="row">
				  <div class="col-md-6">
					<h1>Edit Category</h1>
				  </div>
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="form-group">
								...
								<input class="form-control" type="text" name="name" value="<?php echo $categories->name; ?>" />
							</div>				
						</div>
					</div><!-- /.row -->
</form>