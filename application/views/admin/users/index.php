 ...
 <?php endif; ?>
 <?php if($this->session->flashdata('username_exists')) : ?> 
 	<?php echo '<p class="alert alert-danger">' .$this->session->flashdata('username_exists') . '</p>'; ?>
 <?php endif; ?>
 <?php if($this->session->flashdata('email_exists')) : ?> 
 	<?php echo '<p class="alert alert-danger">' .$this->session->flashdata('email_exists') . '</p>'; ?>
 <?php endif; ?>
