			...
			<div class="row">
				<div class="col-lg-12">
					<ol class="breadcrumb">
				  		...
				  		<li class="active"><i class="fa fa-plus-square-o"></i> Edit Article</li>
					</ol>
				</div>  
			</div><!-- /.row -->
				<div class="row">
					<div class="col-lg-12">
						<div class="form-group">
							...
							<input class="form-control" type="text" name="title" value="<?php echo $article->title; ?>" placeholder="Enter Article Title" />
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<textarea class="form-control" name="body" rows="10"><?php echo $article->body; ?></textarea>
						</div>					
						 <div class="form-group">
							<label>Access</label>
