<?php if($this->session->flashdata('login_success')): ?>
	<div class="alert alert-success"><?php echo $this->session->flashdata('login_success'); ?><strong><?php echo $this->session->userdata['first_name']; ?> <?php echo $this->session->userdata['last_name']; ?></strong></div>
<?php endif; ?>
